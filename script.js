...
fetch('https://restcountries.com/v3.1/all')
  ...
  .then((allCountryData) => {
    allCountryData.forEach((country) => {
      ...
      const cardHtml = `
        <img src=${country.flags.svg} alt="flag" loading="lazy" />
          ...
          <p class="font-bold mb-2">Population:  <span class="font-normal">${country?.population.toLocaleString('en-IN')}</span></p>
          <p class="font-bold mb-2">Region:  <span class="font-normal">${country?.region}</span></p>
          <p class="font-bold mb-2">Capital:  <span class="font-normal">${country?.capital || 'No Capital Available'}</span></p>
          </div>
                  `;
    ...
    errorCard.innerHTML= `Something Wrong! Unable to Fetch &#128577`;
    ...
    countrySection.append(errorCard);
  });
